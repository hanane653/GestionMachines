...
public class InterfaceTechnicien {

	private ScaledImage imgVector = new ScaledImage(InterfaceTechnicien.class.getResource("radeef.jpg"), 270, 360);
	private ScaledImage imgClose = new ScaledImage(InterfaceTechnicien.class.getResource("Close.png"), 16, 16);
	//Inputs
	private ScaledImage imgUsername = new ScaledImage(InterfaceTechnicien.class.getResource("username.png"), 16, 16);
	private ScaledImage imgPassword = new ScaledImage(InterfaceTechnicien.class.getResource("password.png"), 16, 16);
	//Password
	private ScaledImage imgEyeOpen = new ScaledImage(InterfaceTechnicien.class.getResource("open.png"), 16, 16);
	private ScaledImage imgEyeClose = new ScaledImage(InterfaceTechnicien.class.getResource("eye_close.png"), 16, 16);
	JFrame frame;
			...
			public void actionPerformed(ActionEvent e) {
				try {
			        ...
			        while(resultSet.next())
			        {
						...
						if (id_technicien.equals(login) && mot_de_passe.equals(String.valueOf(mdp)))
			        	 {
