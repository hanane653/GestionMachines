...
public class InterfaceUtilisateur {
	...
	private ScaledImage imgVector = new ScaledImage(InterfaceUtilisateur.class.getResource("radeef.jpg"), 270, 360);
	private ScaledImage imgClose = new ScaledImage(InterfaceUtilisateur.class.getResource("Close.png"), 16, 16);
	//Inputs
	private ScaledImage imgUsername = new ScaledImage(InterfaceUtilisateur.class.getResource("username.png"), 16, 16);
	private ScaledImage imgPassword = new ScaledImage(InterfaceUtilisateur.class.getResource("password.png"), 16, 16);
	//Password
	private ScaledImage imgEyeOpen = new ScaledImage(InterfaceUtilisateur.class.getResource("open.png"), 16, 16);
	private ScaledImage imgEyeClose = new ScaledImage(InterfaceUtilisateur.class.getResource("eye_close.png"), 16, 16);
	JFrame frame;
